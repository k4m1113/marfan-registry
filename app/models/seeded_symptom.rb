class SeededSymptom < ActiveRecord::Base
  ...
  validates :systemic_category, presence: true, inclusion: { in: SYSTEMIC_CATEGORIES }
  validates :beighton_value, presence: true, numericality: { only_integer: true }
  validates :ghent_value, presence: true, numericality: { only_integer: true }
end
