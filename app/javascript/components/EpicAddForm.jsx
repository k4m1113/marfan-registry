...
export default class EpicAddForm extends React.Component {
  render() {
    return (
      <div>
        <div className="row">
          <div className="col-sm">
            <div className="input-group">
              <input
                ...
                id="epicMed"
                placeholder="Epic users: .MEDSCURRENT"
              />
        ...
        <div
          ...
          tabIndex="-1"
          role="dialog"
          aria-labelledby="medModalLabel"
          aria-hidden="true"
        >
          <div className="modal-dialog modal-xl" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="medModalLabel">
                  Bulk Add Medication
                </h5>
                <button
                  type="button"
