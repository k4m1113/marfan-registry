...
var parameterizedPlurals = __webpack_require__(12);
...
var _selectConstructor = __webpack_require__(8);
...
module.exports = function selectConstructor(array, title) {
  var other = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  var attribute = arguments[3];
  var parameterizedPlural = arguments[4];
  var rowID = arguments[5];
  var multiSelect = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : '';
  ...
  if (array.length === 1) {
    ...
    array.map(function (item) {
      var optionized = '<option value="' + item + '">' + item + '</option>';
...
var _rowForm = __webpack_require__(33);

var _rowForm2 = _interopRequireDefault(_rowForm);

var _keyify = __webpack_require__(13);

var _keyify2 = _interopRequireDefault(_keyify);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports = function nestedListPane(topicsByType, unsortedTopics, visit, paneKey) {
  var returnStatement = '<div class="topicButtons btn-group" role="group">';
  for (var tg in topicsByType) {
    var topicTypeKey = (0, _keyify2.default)(tg);
  ...
  for (var topicGroup in topicsByType) {
    var typeKey = (0, _keyify2.default)(topicGroup);
    ...
    for (var i = 0; i < topicsByType[topicGroup].length; i++) {
      returnStatement += '' + (0, _rowForm2.default)(topicsByType[topicGroup][i], unsortedTopics, visit);
    }
...
var _assembledHeartMeasurementForm = __webpack_require__(38);
...
var _assembledVitalForm = __webpack_require__(39);

var _assembledVitalForm2 = _interopRequireDefault(_assembledVitalForm);
...
module.exports = function vitals(topics, visit) {
  ...
  var returnStatement = '' + fields.join('');
  return returnStatement;
};
...
var _durationField = __webpack_require__(10);
...
var _findRelated = __webpack_require__(5);

var _findRelated2 = _interopRequireDefault(_findRelated);

var _frequencyField = __webpack_require__(14);
...
var _keywords = __webpack_require__(7);
...
var _timeAgoField = __webpack_require__(6);
...
module.exports = function assembledDissectionForm(topic, unsortedTopics, visit) {
  var rowID = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : topic.id;
  ...
  var returnStatement = '';
  returnStatement += '\n    <tr class=\'row_form\' id=\'row_' + rowID + '\' style=\'display:none\'><td colspan=\'3\'>\n    ' + (0, _hiddenFields2.default)(visit, topic, parameterizedPlural) + '\n      <div class="form-inline">\n        ' + (0, _selectConstructor2.default)(locations, 'location', false, 'location', parameterizedPlural, rowID) + '\n        ' + (0, _selectConstructor2.default)(directions, 'direction', false, 'direction', parameterizedPlural, rowID) + '\n        ' + (0, _selectConstructor2.default)(lumens, 'lumen', false, 'lumen', parameterizedPlural, rowID) + '\n        ' + (0, _selectConstructor2.default)(perfused, 'perfusion', false, 'perfusion', parameterizedPlural, rowID) + '\n        </select>\n      </div>\n      <div class="form-inline">\n        ' + (0, _timeAgoField2.default)(topic, parameterizedPlural) + '\n        ' + (0, _noteField2.default)(topic, parameterizedPlural) + '\n        ' + (0, _fileAttachmentButton2.default)(topic, parameterizedPlural) + '\n\n        What type of intervention was performed?\n      </div>\n      ' + (0, _findRelated2.default)(topic, unsortedTopics) + '\n    </td></tr>\n  ';
  return returnStatement;
};
...
var _measurementField = __webpack_require__(11);
...
var _addKeyboard = __webpack_require__(16);
...
var _infoHover = __webpack_require__(40);
...
module.exports = function presAbsButtons(topic, visit) {
  ...
  if (discussed) {
    var existing = JSON.parse(visit.concerns).filter(function (x) {
...
module.exports = function rowForm(topic, unsortedTopics, visit) {
  ...
  switch (topic.topic_type) {
    ...
    case "dissection":
      returnStatement += '' + (0, _presAbsButtons2.default)(topic, visit);
      returnStatement += '' + (0, _assembledDissectionForm2.default)(topic, unsortedTopics, visit);
      break;
    case "family member":
...
var _tether = __webpack_require__(34);
...
module.exports = function nestedList(allTopics, unsortedTopics, visit) {
  ...
  for (var i = 0; i < allTopics.length; i++) {
    ...
    var k = (0, _keyify2.default)(group);
  ...
  for (var _i = 0; _i < allTopics.length; _i++) {
    ...
    var key = (0, _keyify2.default)(groupName);
    if (_i == 0) {
...
var _epicMeds = __webpack_require__(18);

var _epicMeds2 = _interopRequireDefault(_epicMeds);

var _medMapper = __webpack_require__(19);
...
module.exports = function parseMed(str, visit, allMeds) {
  ...
  for (var i = 0; i < medsArr.length; i++) {
    var commas = (0, _epicMeds2.default)(medsArr[i]);
    commas = commas.map(function (x) {
      return x.trim();
    });
    console.log(commas);
    if (commas[0].includes('(')) {
      var firstParen = commas[0].indexOf('(');
      var secondParen = commas[0].indexOf(')');
      var doseSpace = commas[1].indexOf(' ');
      var lastSpace = commas[1].indexOf(' ', doseSpace + 1);
      medsJSON.push({
        ...
        topicID: (0, _medMapper2.default)(commas[0].slice(0, firstParen - 1), commas[0].slice(firstParen + 1, secondParen), allMeds)
      });
    } else {
      medsJSON.push({
        medicationFormat: commas[0],
        ingestionMethod: commas[1],
        topicID: (0, _medMapper2.default)(commas[0], commas[0], allMeds)
      });
    }
  }
  for (var _i = 0; _i < medsJSON.length; _i++) {
    if (medsJSON[_i].medicationFormat) {
      returnStatement.push('<tr>\n          <td colspan="2">\n            <input value="' + medsJSON[_i].medicationFormat + '" class="form-control" type="text" name="visit[medications_attributes][' + _i + '][name]" id="visit_medications_attributes_' + _i + '_name" />\n          </td>\n          <td>\n            <input value="' + medsJSON[_i].ingestionMethod + '" class="form-control" type="text" name="visit[medications_attributes][' + _i + '][ingestion_method]" id="visit_medications_attributes_' + _i + '_ingestion_method" />\n          </td>\n          <td>\n            <div class="form-check form-check-inline">\n              <label class="form-check-label">\n                <input class="form-check-input" type="radio" name="visit[medications_attributes][' + _i + '][current]" id="visit_medications_attributes_' + _i + '_current_true" value="true"> Continue\n              </label>\n            </div>\n            <div class="form-check form-check-inline">\n              <label class="form-check-label">\n                <input class="form-check-input" type="radio" name="visit[medications_attributes][' + _i + '][current]" id="visit_medications_attributes_' + _i + '_current_false" value="false"> Discontinue\n              </label>\n            </div>\n            <input value="' + visit.id + '" class="form-control" type="hidden" name="visit[medications_attributes][' + _i + '][visit_id]" id="visit_medications_attributes_' + _i + '_visit_id" />\n            <input value="' + visit.patient_id + '" class="form-control" type="hidden" name="visit[medications_attributes][' + _i + '][patient_id]" id="visit_medications_attributes_' + _i + '_visit_id" />\n            <input value="' + medsJSON[_i].topicID + '" class="form-control" type="hidden" name="visit[medications_attributes][' + _i + '][topic_id]" id="visit_medications_attributes_' + _i + '_topic_id" />\n          </td>\n        </tr>');
    } else {
      returnStatement.push('<tr>\n          <td>\n            <div class="form-inline">\n              <input value="' + medsJSON[_i].name + '" class="form-control" type="text" name="visit[medications_attributes][' + _i + '][name]" id="visit_medications_attributes_' + _i + '_name" style=\n              "max-width:8em;" />\n              <input value="' + medsJSON[_i].commonName + '" class="form-control" type="text" name="visit[medications_attributes][' + _i + '][common_name]" id="visit_medications_attributes_' + _i + '_common_name" style=\n              "max-width:8em;" />\n            </div>\n          </td>\n          <td>\n            <div class="form-inline">\n              <input value="' + medsJSON[_i].dose + '" class="form-control" style="max-width:6em;" type="number" name="visit[medications_attributes][' + _i + '][dose]" id="visit_medications_attributes_' + _i + '_dose" />\n              <input value="' + medsJSON[_i].doseUnitOfMeas + '" class="form-control" style="max-width:6em;" type="text" name="visit[medications_attributes][' + _i + '][dose_unit_of_measurement]" id="visit_medications_attributes_' + _i + '_dose_unit_of_measurement" />\n              <input value="' + medsJSON[_i].dosageForm + '" class="form-control" type="text" name="visit[medications_attributes][' + _i + '][dosage_form]" id="visit_medications_attributes_' + _i + '_dosage_form" />\n            </div>\n          </td>\n          <td>\n            <input value="' + medsJSON[_i].ingestionMethod + '" class="form-control" type="text" name="visit[medications_attributes][' + _i + '][ingestion_method]" id="visit_medications_attributes_' + _i + '_ingestion_method" />\n          </td>\n          <td>\n            <div class="form-check form-check-inline">\n              <label class="form-check-label">\n                <input class="form-check-input" type="radio" name="visit[medications_attributes][' + _i + '][current]" id="visit_medications_attributes_' + _i + '_current_true" value="true"> Continue\n              </label>\n            </div>\n            <div class="form-check form-check-inline">\n              <label class="form-check-label">\n                <input class="form-check-input" type="radio" name="visit[medications_attributes][' + _i + '][current]" id="visit_medications_attributes_' + _i + '_current_false" value="false"> Discontinue\n              </label>\n            </div>\n            <input value="' + visit.id + '" class="form-control" type="hidden" name="visit[medications_attributes][' + _i + '][visit_id]" id="visit_medications_attributes_' + _i + '_visit_id" />\n            <input value="' + visit.patient_id + '" class="form-control" type="hidden" name="visit[medications_attributes][' + _i + '][patient_id]" id="visit_medications_attributes_' + _i + '_visit_id" />\n            <input value="' + medsJSON[_i].topicID + '" class="form-control" type="hidden" name="visit[medications_attributes][' + _i + '][topic_id]" id="visit_medications_attributes_' + _i + '_topic_id" />\n          </td>\n        </tr>');
    }
  }
  return returnStatement;
};
...
module.exports = function unitConverter(desiredUnit, amount) {
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["$"] = __webpack_require__(71);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["$"] = __webpack_require__(97);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["addKeyboard"] = __webpack_require__(42);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["assembledDiagnosisForm"] = __webpack_require__(48);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["assembledDissectionForm"] = __webpack_require__(49);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["assembledHospitalizationForm"] = __webpack_require__(50);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["assembledMeasurementForm"] = __webpack_require__(51);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["assembledMedicationForm"] = __webpack_require__(52);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["assembledProcedureForm"] = __webpack_require__(53);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["epicMeds"] = __webpack_require__(43);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["medMapper"] = __webpack_require__(44);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["nestedList"] = __webpack_require__(45);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["parseMed"] = __webpack_require__(46);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["reasonForVisitHeader"] = __webpack_require__(47);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["rowForm"] = __webpack_require__(54);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["scribbleButton"] = __webpack_require__(55);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["unitConverter"] = __webpack_require__(56);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["visitHeader"] = __webpack_require__(57);
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(jQuery) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! jQuery UI Virtual Keyboard v1.26.25 *//*
