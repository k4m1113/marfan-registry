  ...
  for (var _i = 0; _i < allTopics.length; _i++) {
    ...
    switch (groupName) {
      case 'family history':
        ...
        break;
      case 'vitals':
        panes += (0, _vitals2.default)(topicsByType.vital, visit) + '</div>';
        break;
      case 'cardiovascular':
...
module.exports = function assembledHeartMeasurementForm(topic, visit) {
  ...
  var parameterizedPlural = 'heart_measurements';
  var returnStatement = '<div class="form-group row">\n  <div class="col-3 col-form-label">\n    ' + topic.name + '\n  </div>\n  <div class="col-9 form-inline">\n    ' + (0, _hiddenFields2.default)(visit, topic, parameterizedPlural);
  if (topic.units_of_measurement.length == 1 || !topic.name.includes('morphology')) {
    returnStatement += '' + (0, _measurementField2.default)(topic, parameterizedPlural, null, 'severity');
  } else {
