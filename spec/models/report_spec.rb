...
describe Report do
  ...
  describe '.meds_paragraph' do
    meds = visit.meds_paragraph
    it 'returns \'no\' statement if empty' do
      expect(meds).to eq 'I did not discuss any medications with Antoine during our visit.'
    end
    it 'includes name of patient' do
      expect(meds).to match visit.patient.first_name
    end
  end
  ...
  describe '.imagery_paragraph' do
    ...
    it 'returns \'no\' statement if empty' do
      expect(imagery).to eq 'Antoine did not undergo any heart imagery as part of our visit.'
    end
    it 'includes name of patient' do
